...
class StatusResp(BaseModel):
    ...
    sensor_units_under_range: bool = Field(..., alias="sensor units under range")
...
class CurveDataPoints(BaseModel):
    ...
    channel: int
    temperatures: list[float] = Field(..., description="List of temperature values")
...
class Brightness(BaseModel):
    ...
    brightness: int = Field(..., ge=0, le=100, description="Brightness level between 0 and 100")
